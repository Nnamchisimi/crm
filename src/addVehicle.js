...
const AddVehicle = () => {
  ...
  // 🚨 FIX APPLIED: This is the CORRECTED and SINGLE definition of handleSubmit 
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <TextField
              ...
              onChange={handleChange} // Use the custom handleChange to reset model
              fullWidth
              required
              margin="normal"
              InputLabelProps={{ style: { color: "#ccc" } }}
